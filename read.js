 ...
 */
async function findByGender(client, value) {
    // See https://mongodb.github.io/node-mongodb-native/3.6/api/Collection.html#findOne for the findOne() docs
    const result = await client.db("sample_airbnb").collection("listingsAndReviews").findOne({ "document.aadhar.gender": value});
...
async function findByName(client,value){
    ...
    if (result) {
        console.log(`Found a listing in the collection with the name '${result.document.aadhar.gender}'`);
        // console.log(result);
    } else {
        console.log(`No listings found with the name`);
    }
