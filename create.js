...
async function main(){
    ...
    try {
        ...
        await createListing(client,
            {"_id":"111111","email":"email@example.com","name":{"given":"Jane","family":"Han"},"address":{"street":"111 Elm Street","city":"Springfield","state":"MH","country":"India","zip":"00000"},"document":{"aadhar":{"uploadURL":"https://aadhar/adress/MH?redirectfrom=directory","gender":"Male"}},"_class":"com.training.mogodb.model.User"}
        );
